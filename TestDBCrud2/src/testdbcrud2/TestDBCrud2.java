...
//        saveData("Nusrat", "nusrat@gmail.com", "Mirpur", "232123434");
//        deleteData(2);
        updatedata("Raju Ahmed", "raju@email.com", "Azimpur", "01432323407", 3);
        showData();
    ...
    public static void showData(){
        ...
        try {
            ...
            Logger.getLogger(TestDBCrud2.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void updatedata(String name, String email, String address, String cell, int id){
